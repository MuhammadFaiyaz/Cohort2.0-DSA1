...
// check if numbers are ascending in a string
...
// reverse prefix of the word
let word = "abcdefg";
let ch = "d";

let sliced = word.split("");
...
let rev = word
  ...
  .reverse()
  .join("");
let rest = word.slice(ind + 1);
let finalStr = rev + rest;
